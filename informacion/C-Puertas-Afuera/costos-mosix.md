...
| **Costo inicial histórico** | $61,141.25 USD (obsoleto, año 2000) |
...
*Documento preparado para Fundamentos de Sistemas Operativos — Sección "Puertas Afuera" — Mayo 2026*
...
- **Costos de transacción en adopción de SO**: El histórico precio de $61,141.25 USD para una licencia de cluster representa las "barreras de entrada" que el software propietario imponía, a diferencia de alternativas gratuitas actuales; esto conecta con cómo los modelos de distribución determinan la adopción institucional.
